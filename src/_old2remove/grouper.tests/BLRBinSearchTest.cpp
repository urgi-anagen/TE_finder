 ...
 *    include grouper/BLRBinSearchTest.mk
 * Build the grouper/BLRBinSearchTest.mk target from the Make Target view
 */

#ifndef TEST_BLRBinSearchTest
#define TEST_BLRBinSearchTest
...
class BLRBinSearchTest : public CppUnit::TestFixture {
	BLRBinSearch blrBs;
	BLRExhaustSearch blrEs;
public:

	BLRBinSearchTest(void) : blrBs(),blrEs() {}
	...
	CPPUNIT_TEST_SUITE(BLRBinSearchTest);
	CPPUNIT_TEST(testsearchFound);
	CPPUNIT_TEST(testsearchNotFound);
	CPPUNIT_TEST_SUITE_END();
};
CPPUNIT_TEST_SUITE_REGISTRATION(BLRBinSearchTest);
#endif
