/*
 * \file BLRMemIdxEBV.cpp
 */

#include "BLRMemIdxEBV.h"
...
{
	srangeE->insert( m.getNumChr(), m.getMin(), m.getMax(), m.id );
	srangeB->insert( m.getNumChr(), m.getMin(), m.getMax(), m.id );
	srangeV->insert( m.getNumChr(), m.getMin(), m.getMax(), m.id );
...
void BLRMemIdx::erase_member_idx( unsigned id )
{
	if(vec_idx[id]!=NULL)
	{
		srangeE->erase(vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member);
		srangeB->erase(vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member);
		srangeV->erase(vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member);
		delete vec_idx[id];
...
void BLRMemIdx::adjust_member_idx(unsigned id, unsigned start, unsigned end)
{
	if(vec_idx[id]!=NULL)
	{
		...
		vec_idx[id]->end = end;
		srangeE->insert( vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member );
		srangeB->insert( vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member );
		srangeV->insert( vec_idx[id]->seq,
				vec_idx[id]->start,
				vec_idx[id]->end,
				vec_idx[id]->id_member );
	}
