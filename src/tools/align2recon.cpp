...
void help ( char *programName )
{
  ...
  cout << "     -o: name of the ouput file (default=inFileName+'.msp')" << endl;
...
void align2recon( ifstream &inFile, ofstream &outFile, int verbose )
{
  int countLine = 0;
  ...
  while ( ! inFile.eof() )
	...
	break;
 	...
 	cout << line << endl;
      ...
      outLine << score << " " << identity << " " << qryStart << " " << qryEnd << " " << qryName << " " << sbjStart << " " << sbjEnd << " " << sbjName << "\n";
...
int main ( int argc, char **argv )
{
  ...
  align2recon( inFile, outFile, verbose );
