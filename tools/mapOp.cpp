...
void help(void)
{
  std::cerr<<"usage: mapOp"
      ...
      <<"   -k, --keep:\n\t keep subject when query overlap (option -o) or is included (option -i), default: true"<<std::endl
      <<"   -r, --delete:\n\t delete subject when query  overlap (option -o) or is included (option -i), default: false"<<std::endl
      <<"   -d, --diff:\n\t delete subject coordinate according to query overlap, default: false"<<std::endl
      <<"   -f, --outfile:\n\t output filename, default: <subject map>.[keepInclude,keepOverlap,deleteInclude,deleteOverlap, ...]"<<std::endl;
};
