...
void help ( char *programName )
{
  ...
  cout << "     -i: name of the input file (format='tab')" << endl;
  cout << "     -o: name of the ouput file (default=inFileName+'.out')" << endl;
...
void tabnum2id( ifstream &inFile, ofstream &outFile, int verbose )
{
  ...
  while ( ! inFile.eof() )
	...
	break;
 	...
 	cout << line << endl;
      ...
      if( tokens[0] != "query.name" )
	{
	  string ID = tokens[14] + "-" + tokens[0] + "-" + tokens[6];
	  ...
	  newPath_str << newPath;
	  string outLine =  tokens[0] + "\t" + tokens[1] + "\t" + tokens[2] + "\t" + tokens[3] + "\t" + tokens[4] + "\t" + tokens[5] + "\t" + tokens[6] + "\t" + tokens[7] + "\t" + tokens[8] + "\t" + tokens[9] + "\t" + tokens[10] + "\t" + tokens[11] + "\t" + tokens[12] + "\t" + tokens[13] + "\t" + newPath_str.str() + "\n";
...
int main ( int argc, char **argv )
{
  ...
  tabnum2id( inFile, outFile, verbose );
