...
class Test_RangePairSet: public CPPUNIT_NS::TestFixture
{
	...
	CPPUNIT_TEST( view_diffQ_symetric );
	...
	CPPUNIT_TEST( test_equality_rps1_rps2_different_length);
        CPPUNIT_TEST( test_computeScoreWithLength_two_match_part );
        CPPUNIT_TEST( test_overlapQ_length_length );
        CPPUNIT_TEST( test_overlapQ_length_length_2 );
        CPPUNIT_TEST( test_overlapQ_length_length_symetric );
        CPPUNIT_TEST( test_mergeQ_score_rps1_greater_score_than_rps2 );
   ...
   void view_diffQ_symetric(void);
   void test_equality(void);
   void test_equality_not_equal(void);
   void test_equality_rps1_rps2_different_length(void);
   ...
   void test_overlapQ_length_length_2(void);
   void test_overlapQ_length_length_symetric(void);
   void test_mergeQ(void);
   void test_mergeQ_score_rps1_greater_score_than_rps2(void);
