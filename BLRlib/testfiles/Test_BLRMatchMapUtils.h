...
class Test_BLRMatchMapUtils
{
	...
	static void writeInputFileWithTwoMatchesToBeJoined(void);
        ...
        static BLRMatcherParameter createParameterWithThreads(void);
        static BLRMatcherParameter createParameter(SDGString inputFileName);
	...
	static std::list<RangePairSet> createInputRpsList_for_test_reComputeScoreWithLength_on_a_match_with_one_match_part(void);
	static std::list<RangePairSet> createExpRpsList_for_test_reComputeScoreWithLength_on_a_match_with_one_match_part(void);
	static std::list<RangePairSet> createInputRpsList_for_test_reComputeScoreWithLength_on_a_match_with_two_match_part(void);
	static std::list<RangePairSet> createExpRpsList_for_test_reComputeScoreWithLength_on_a_match_with_two_match_part(void);
